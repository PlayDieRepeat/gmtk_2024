...
func increase_population(p_pop_to_add: int) -> int:
	var result := -1
	return result

func decrease_population(p_pop_to_remove: int) -> int:
	var result := -1
	return result
...
func increase_hunger(p_hunger_to_add: ) -> int:
	var result := -1
	return result

func decrease_hunger(p_hunger_to_remove: ) -> int:
	var result := -1
	return result
...
func increase_fulfillment(p_fulfillment_to_add: int) -> int:
	var result := -1
	return result

func decrease_fulfillment(p_fulfillment_to_add: int) -> int:
	var result := -1
	return result
